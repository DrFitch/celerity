...
var _traderjoe_router = require('./abi/avax/traderjoe_router.json');

var _traderjoe_router2 = _interopRequireDefault(_traderjoe_router);

var _traderjoe_factory = require('./abi/avax/traderjoe_factory.json');

var _traderjoe_factory2 = _interopRequireDefault(_traderjoe_factory);
...
const web3 = new _web2.default(rpcURL);
...
async function benchmark() {
    ...
    var spinner = new _cliSpinner.Spinner('Running benchmark... %s');
...
async function checkAvaxPrice() {
    ...
    let amountOut;
    try {
        let router = new web3.eth.Contract(_traderjoe_router2.default, '0x60aE616a2155Ee3d9A68541Ba4544862310933d4'.toLocaleLowerCase()); // router address
